...
import ThankYoupageo from "./2023/components/ThankYoupageo";
import ThankYoupaget from "./2023/components/ThankYoupaget";
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route path="/form1" element={<ThankYoupageo />} />
          <Route path="/form2" element={<ThankYoupaget />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
